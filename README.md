...
- `dcirc.sh` environment file with DCI credentials
...
3. (Optional) Set up DCI credentials in `dcirc.sh`:
```bash
...
├── dcirc.sh                        # DCI environment configuration
├── README.md                       # This file
...
- Check DCI credentials in `dcirc.sh`
